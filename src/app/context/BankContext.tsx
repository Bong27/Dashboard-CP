...
const INITIAL_BANKS: BankEntry[] = [
  { id: 'wise',     label: 'Wise',     bankName: 'Wise Payments Limited', holder: 'Acme Corp', iban: 'GB97 TRWI 2308 0120 5078 10', accountNumber: '20507810', bic: 'TRWIGB2LXXX', address: 'Flat 4, 25 Baker Street', city: 'London', postalCode: 'W1U 8EE',  country: 'United Kingdom' },
  { id: 'barclays', label: 'Barclays', bankName: 'Barclays Bank PLC',     holder: 'Acme Corp', iban: 'GB29 NWBK 6016 1331 9268 19', accountNumber: '31926819', bic: 'BARCGB22XXX', address: '1 Churchill Place',     city: 'London', postalCode: 'E14 5HP', country: 'United Kingdom' },
  { id: 'hsbc',     label: 'HSBC',     bankName: 'HSBC UK Bank PLC',      holder: 'Acme Corp', iban: 'GB94 MIDL 4005 1512 3456 78', accountNumber: '12345678', bic: 'MIDLGB22XXX', address: '8 Canada Square',       city: 'London', postalCode: 'E14 5HQ', country: 'United Kingdom' },
];
