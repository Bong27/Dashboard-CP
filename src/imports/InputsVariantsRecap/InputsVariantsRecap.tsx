import svgPaths from "./svg-ysryxkgv78";
...
function Controls4() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0" data-name="controls">
      <Currency />
      <Selector3 />
    </div>
  );
...
export default function InputsVariantsRecap() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[25px] items-start p-[40px] relative size-full" data-name="Inputs Variants Recap">
      ...
      <div className="bg-white h-[56px] min-w-[200px] relative rounded-[5px] shrink-0 w-full" data-name="Input Master">
        <div className="min-w-[inherit] overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[20px] items-start min-w-[inherit] p-[10px] relative size-full">
            <Content5 />
            <Controls5 />
          </div>
        </div>
